...
" 2>/dev/null || echo "0")"
  ...
  echo -e "${BOLD}${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
  echo ""
  echo -e "  ${BOLD}公开展示页：${RESET} http://${server_ip}:4500/"
  echo -e "  ${BOLD}管理后台：  ${RESET} http://${server_ip}:4500/admin.html"
  echo -e "  ${YELLOW}提示：${RESET} 如需公网 TLS，请由您自行管理反向代理；安装程序不会修改系统代理配置。"
  echo ""
