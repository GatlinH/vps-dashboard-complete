...
class AffProduct(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    provider = db.Column(db.String(128), nullable=False, index=True)   # 服务商名称
    stock = db.Column(db.String(16), default="avail", index=True)      # avail/low/out
    ...
    period = db.Column(db.String(16), default="monthly")              # monthly/yearly/once
