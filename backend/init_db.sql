...
-- 创建应用用户（应用访问）
CREATE USER IF NOT EXISTS 'vps_user'@'localhost' IDENTIFIED BY 'vps_dashboard_2024_secure';
CREATE USER IF NOT EXISTS 'vps_user'@'%' IDENTIFIED BY 'vps_dashboard_2024_secure';
...
INSERT IGNORE INTO `aff_products` (`id`,`provider`,`stock`,`cpu`,`ram`,`disk`,`bandwidth`,`location`,`price`,`currency`,`period`,`buy_url`,`note`,`sort_order`) VALUES
(1,'RackNerd','avail','1 vCPU','1 GB','15 GB SSD','1.5 TB/月','美国洛杉矶',99,'CNY','yearly','https://www.racknerd.com','年付特惠，性价比极高',10),
(2,'Vultr','avail','1 vCPU','1 GB','25 GB SSD','1 TB/月','全球25节点',42,'CNY','monthly','https://www.vultr.com','按小时计费，随时销毁',20),
(3,'BandwagonHost','low','2 vCPU','2 GB','40 GB SSD','2 TB/月','香港/美国',299,'CNY','yearly','https://bandwagonhost.com','CN2 GIA 线路，延迟极低',30);
